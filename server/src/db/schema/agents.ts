...
export const agents = pgTable(
  ...
  // Cascade target for a workspace delete; also the list-agents predicate.
...
export const agentSkills = pgTable(
  ...
  (t) => ({
    ...
    // agent_id leads the PK so it is already covered; skill_id is not, and it
    // cascades from `skills` — without this, deleting a skill seq-scans here.
