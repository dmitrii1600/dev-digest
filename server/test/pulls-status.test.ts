 ...
 * decides each PR's review STATUS for the list. The DB `status` column holds
 * GitHub's merge state; the review status
...
import { deriveReviewStatus, STALE_DAYS } from '../src/modules/pulls/status.js';
