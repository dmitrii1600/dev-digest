      ...
      >
        <div style={s.statsRow}>
          ...
          <Stat
            ...
            // "—" for a trace persisted before the cost badge, or a run whose
            // provider reported no usage. Never "$0.00" — unknown is not free.
            val={stats.cost_usd != null ? formatRunCost(stats.cost_usd) : "—"}
          />
